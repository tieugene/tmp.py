...
class MainWindow(QMainWindow):
    def __init__(self, _, parent=None):
        ...
        cw: QtChart.QChartView = QtChart.QChartView()
    ...
    def setup_chart(cw: QtChart.QChartView):
        def mk_xaxis() -> QtChart.QValueAxis:
            xaxis = QtChart.QValueAxis()
            xaxis.setTickType(QtChart.QValueAxis.TicksDynamic)
        ...
        series: QtChart.QLineSeries = QtChart.QLineSeries()
